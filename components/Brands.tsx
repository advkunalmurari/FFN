          ...
          >
            <div className="flex flex-col md:flex-row items-start gap-10">
               <div className="w-24 h-24 rounded-[2rem] bg-gray-50 flex items-center justify-center p-4 shadow-inner">
                  <img src={brand.logoUrl} className="w-full grayscale group-hover:grayscale-0 transition-all" alt="" />
               </div>
               <div className="flex-1 space-y-6">
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <h3 className="text-4xl font-serif italic text-ffn-black">{brand.name}</h3>
