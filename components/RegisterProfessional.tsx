              ...
              >
                ...
                <div className="space-y-8">
                  <motion.button 
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full bg-ffn-black text-white py-10 rounded-[3rem] text-xs font-black uppercase tracking-[0.5em] flex items-center justify-center space-x-6 shadow-3xl hover:bg-ffn-primary transition-all"
                  >
                    {isProcessing ? (
                      <>
                        <Loader2 className="w-6 h-6 animate-spin" />
                        <span>Processing Identity Activation...</span>
                      </>
                    ) : (
                      <>
                        <CreditCard className="w-6 h-6" />
                        <span>Activate Professional Hub</span>
                      </>
                    )}
                  </motion.button>
                  <p className="text-[9px] uppercase tracking-[0.4em] text-gray-300 text-center font-black flex items-center justify-center space-x-3">
                    ...
                    <span>Razorpay Secured Network Protocol</span>
                  </p>
                </div>
              </motion.div>
            )}
