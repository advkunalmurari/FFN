...
export const PricingPage: React.FC<{ onRegister: () => void }> = ({ onRegister }) => (
  <div className="py-20 space-y-24 animate-in fade-in duration-1000">
    <header className="max-w-4xl mx-auto text-center space-y-8">
      ...
      <p className="text-xl text-gray-400 font-light italic">One-time lifecycle fees for global professional sovereignty. No subscriptions.</p>
    </header>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
       <div className="bg-white p-16 rounded-[4rem] border border-gray-100 shadow-2xl space-y-10 relative overflow-hidden group">
          ...
          <button onClick={onRegister} className="w-full bg-ffn-black text-white py-8 rounded-[2rem] text-[11px] font-black uppercase tracking-[0.5em] shadow-xl hover:bg-ffn-primary transition-all">Activate Hub</button>
       </div>
       ...
       <div className="bg-ffn-black text-white p-16 rounded-[4rem] shadow-2xl space-y-10 relative overflow-hidden group">
          ...
          <button className="w-full bg-white text-ffn-black py-8 rounded-[2rem] text-[11px] font-black uppercase tracking-[0.5em] shadow-xl hover:bg-ffn-primary hover:text-white transition-all">Boost Identity</button>
       </div>
    </div>
  </div>
);
